...
<base target="_blank">
<style>
  html,body{margin:0;padding:0;background:transparent;color:#111;font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;font-size:14px;line-height:1.5;word-wrap:break-word;overflow-wrap:anywhere;}
  body{padding:8px;}
